...
- Knowledge ingestion: file upload / manual Q&A (site crawling is
  `docs/open-questions.md` #4, not yet decided)
...
- **Design pass on `/bots` and `/bots/[botId]`** — see CLAUDE.md's
  Current State; the auth pages got a real design pass, these haven't.
